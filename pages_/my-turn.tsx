    ...
    <Layout>
      <Card className="cauda_card myturn__card mb-4 mx-auto">
        ...
        <Card.Body className="p-2 text-center">
          ...
          <img className="myturn__qrcode img-fluid rounded mb-3" src={img_qrcodeUrl}></img>

          <p className="myturn__timebox h2 font-weight-light mb-1"><span className="myturn__time font-weight-bold">25</span> {t('common:minutes')}</p>

          <p className="h6 mb-3 text-uppercase text-muted font-weight-light">Tiempo Restante Estimado</p>

          <Card className="myturn__turns mb-5">
            <Card.Body className="text-center">

              <p className="h6 text-uppercase text-muted font-weight-light">Últimos Números Atendidos</p>
